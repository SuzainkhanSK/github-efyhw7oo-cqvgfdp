...
const TasksPage: React.FC = () => {
  ...
  const availableTasks: Task[] = [
    {
      ...
      description: 'Watch video ads to earn up to 775 points daily with our tiered reward system!',
      points: 'Up to 775',
      type: 'ads',
      action_url: '/special-tasks/watch-ads',
      icon: Video,
  ...
  const handleTaskAction = async (task: Task) => {
    ...
    if (task.type === 'ads') {
      // Navigate to the Watch Ads page
